...
// import { selectMemberDetails } from '../+state/gyms.selector';
// import { GymStatusEnum } from '../+state/enums/gym-status.enum';
// import { MembersActions } from '../+state/gyms.action';
//
// @Component({
//   standalone: true,
//   imports: [CommonModule, ReactiveFormsModule, NgxUiLoaderModule],
//   templateUrl: './gym-for-creation.modal.html',
//   styleUrl: './gym-for-creation.modal.scss'
// })
// export class GymForCreationModal implements OnInit, OnDestroy {
...
//       if (memberTemplateState.status === GymStatusEnum.createSuccess) {
//         this.dismissModal();
//       }
//     }));
//   }
